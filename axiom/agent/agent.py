...
def generate_reply(
    ...
    if kps:
        ...
        system += (
            ...
            "ходу) — выстави kp_choice РОВНО равным названию нужного КП из списка ниже. Если по "
            "сценарию нужно отправить НЕСКОЛЬКО — перечисли их названия через запятую, уйдут все. "
            "Если рано или не уверен — оставь kp_choice=null. Не отправляй в первое касание.\n"
