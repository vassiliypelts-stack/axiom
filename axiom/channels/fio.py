...
# Пул ru_names — это 40 имён для персон купленных аккаунтов, для разбора живой базы
# его мало. Расширяем распространёнными именами: половина женских кончается на «-ина»
# («Ангелина», «Кристина», «Полина») и неотличима по суффиксу от фамилии, поэтому в
# паре «Ангелина Лео» именем без списка оказывалось «Лео».
_MORE_FIRST = {
    # мужские
    "Алексей", "Анатолий", "Аркадий", "Арсений", "Артур", "Борис", "Вадим", "Валентин",
    "Валерий", "Василий", "Виктор", "Виталий", "Вячеслав", "Геннадий", "Георгий", "Глеб",
    "Григорий", "Денис", "Евгений", "Захар", "Константин", "Лев", "Леонид", "Макар",
    "Марк", "Матвей", "Мирон", "Мстислав", "Назар", "Николай", "Пётр", "Петр", "Родион",
    "Ростислав", "Руслан", "Рустам", "Святослав", "Семён", "Семен", "Станислав", "Степан",
    "Тимофей", "Тимур", "Фёдор", "Федор", "Филипп", "Эдуард", "Юрий", "Ярослав",
    # женские
    "Аврора", "Агата", "Аделина", "Айгуль", "Алевтина", "Александра", "Алёна", "Алена",
    "Алиса", "Алина", "Анастасия", "Ангелина", "Анжела", "Анжелика", "Антонина", "Валерия",
    "Варвара", "Вера", "Вероника", "Галина", "Диана", "Дина", "Ева", "Евгения", "Жанна",
    "Зинаида", "Злата", "Зоя", "Инга", "Инна", "Карина", "Кира", "Клавдия", "Лариса",
    "Лидия", "Лилия", "Любовь", "Маргарита", "Милана", "Надежда", "Наталия", "Натали",
    "Нелли", "Нина", "Оксана", "Раиса", "Регина", "Римма", "Роза", "Руслана", "Сабина",
    "Снежана", "Стелла", "Таисия", "Тамара", "Ульяна", "Эвелина", "Эльвира", "Эмма",
    "Яна", "Ярослава",
}


def _is_known_first(token: str) -> bool:
    """Имя есть в списке распространённых русских имён."""
    cap = _letters(token).capitalize()
    return (cap in ru_names._MALE_FIRST or cap in ru_names._FEMALE_FIRST
            or cap in _MORE_FIRST)
